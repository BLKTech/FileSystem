...
{   
    ...
    public function exists()                    {return self::pathExists($this);}       
    public function isFile()                    {return self::pathIsFile($this);}        
    public function isLink()                    {return self::pathIsLink($this);}        
    public function getParent()                 {return new Directory(parent::getParent(), parent::getDirectorySeparator());}        
    public function isReadable()                {return self::pathIsReadable($this);}    
    public function isWritable()                {return self::pathIsWritable($this);}
    public function isDirectory()               {return self::pathIsDirectory($this);}        
    public function getFreeSpace()              {return self::pathGetFreeSpace($this);}   
    public function getTotalSpace()             {return self::pathGetTotalSpace($this);}       
